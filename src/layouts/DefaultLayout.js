    ...
    <>
      <nav className={cls('header')}>
        <div className={cls('headerLeft')}>
          <div className={cls('size-bg')}>
            <button className={cls('show-bg-icon')}>
              <svg
                viewBox='0 0 24 24'
                preserveAspectRatio='xMidYMid meet'
                focusable='false'
                className={cls('bg-icon')}
              >
                <g>
          ...
          <div className={cls('logoHeader')}>
            ...
            <span className={cls('brandIcon-sup')}>VN</span>
          </div>
        </div>

        <div className={cls('headerCenter')}>
          <div className={cls('groupSearch')}>
            <form action='' className={cls('searchBox')}>
              <input
                type='text'
                id='search'
            ...
            <button className={cls('layoutIcon-search')}>
              <label htmlFor='search' className={cls('layoutIcon-search-sup')}>
                <svg
                  viewBox='0 0 24 24'
                  preserveAspectRatio='xMidYMid meet'
                  focusable='false'
        ...
        {currentUser ? (
          <div className={cls('headerRight')}>
            <div className={cls('size-bg', 'mgr')}>
              <Link to={'/createcontent'} className={cls('show-bg-icon')}>
                <svg
                  viewBox='0 0 24 24'
                  preserveAspectRatio='xMidYMid meet'
                  focusable='false'
            ...
            <input
              ...
              hidden
              id='checkDropdown'
              className={cls('checkDropdown-menu')}
            />
            <label htmlFor='checkDropdown' className={cls('bg-cl-trans')}></label>
            <label htmlFor='checkDropdown' className={cls('sizeM-bg')}>
              <span className={cls('bg-color', 'bgM-icon')}>
                {currentUser.username.slice(0, 1).toUpperCase()}
              </span>
            </label>
            <div className={cls('dropdown-menu')}>
              <div className={cls('baseProfile')}>
                <div className={cls('baseProfile-mr')}>
                  <span className={cls('bg-color', 'bgM-icon')}>
                    {currentUser.username.slice(0, 1).toUpperCase()}
                  </span>
                </div>
                <div className={cls('inforProfile')}>
                  <span className={cls('inforProfile-user')}>{currentUser.username}</span>
                  <span>{currentUser.email}</span>
                  <span className={cls('inforProfile-link')}>Manage your Google Account</span>
                </div>
              </div>
              <div className={cls('dropdown-divider')}></div>
              <Link className={cls('dropdown-item')} to={'/mychannel'}>
                <svg
                  viewBox='0 0 24 24'
                  preserveAspectRatio='xMidYMid meet'
                  focusable='false'
              ...
              <div className={cls('dropdown-item', 'btn')}>
                <svg
                  viewBox='0 0 24 24'
                  preserveAspectRatio='xMidYMid meet'
                  focusable='false'
          ...
          <div className={cls('navbar-nav ml-auto')}>
            {signin && (
              <Link
                to={'/login'}
                className={cls('nav-link layout')}
                onClick={handleClickSignin}
              >
                <span>Sign-in &nbsp;</span>
                <i className={cls('fa fa-sign-in size-icon')}></i>
              </Link>
            )}
          </div>
        )}
